...
**Partition**  
Entrada: Conjunto S de números enteros positivos.

Salida: Dos subconjuntos S1 y S2, en el que la suma de los números de S1 es igual a la suma de los números en S2.
